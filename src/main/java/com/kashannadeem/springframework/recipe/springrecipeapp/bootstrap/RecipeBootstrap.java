package com.kashannadeem.springframework.recipe.springrecipeapp.bootstrap;

import com.kashannadeem.springframework.recipe.springrecipeapp.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        log.info(guacRecipe.getDescription() + " recipe added");
        ...
        log.info(tacosRecipe.getDescription() + " recipe added");
        return recipes;
    }
}
