...
import com.kashannadeem.springframework.recipe.springrecipeapp.services.ImageService;
...
class ImageControllerTest {
    ...
    void showUploadForm() throws Exception {
        ...
        //when
        mockMvc.perform(get("/recipe/" + command.getId() + "/image"))
    ...
    void renderImageFromDB() throws Exception {
        ...
        //when
        MockHttpServletResponse response = mockMvc.perform(get("/recipe/" + command.getId() + "/recipeImage"))
                .andExpect(status().isOk())
