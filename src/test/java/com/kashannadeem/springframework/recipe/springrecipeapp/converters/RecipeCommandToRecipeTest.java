...
import com.kashannadeem.springframework.recipe.springrecipeapp.commands.CategoryCommand;
import com.kashannadeem.springframework.recipe.springrecipeapp.commands.IngredientCommand;
import com.kashannadeem.springframework.recipe.springrecipeapp.commands.NotesCommand;
...
class RecipeCommandToRecipeTest {
    ...
    public static final String s = "fake image text";
    public static final Byte[] IMAGE = new Byte[s.getBytes().length];
